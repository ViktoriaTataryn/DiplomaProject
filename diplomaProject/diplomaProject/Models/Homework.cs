...
public class Homework
{
    ...
    public required string Description { get; set; } // Описание того, что нужно сделать

    [Display(Name = "Due Date")] public DateTime? DueDate { get; set; } // Крайний срок сдачи (дедлайн)
