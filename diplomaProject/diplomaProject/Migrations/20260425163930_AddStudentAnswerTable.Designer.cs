...
namespace diplomaProject.Migrations
{
    ...
    [Migration("20260425163930_AddStudentAnswerTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("diplomaProject.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentAnswer", b =>
                {
                    b.HasOne("diplomaProject.Models.HomeworkSubmission", "HomeworkSubmission")
                    ...
                    b.HasOne("diplomaProject.Models.AnswerOption", "SelectedOption")
                        .WithMany()
            ...
            modelBuilder.Entity("diplomaProject.Models.HomeworkSubmission", b =>
                {
                    b.HasOne("diplomaProject.Models.Homework", "Homework")
                        .WithMany("Submissions")
                        .HasForeignKey("HomeworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("diplomaProject.Models.ApplicationUser", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("diplomaProject.Models.Review", b =>
                {
                    b.HasOne("diplomaProject.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
